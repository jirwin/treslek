...
TreslekBot.prototype.start = function() {
  ...
  this.irc.treslekProcessMessage = function(from, to, text, msg) {
    ...
    if (from !== that.conf.nick && that.conf.ignored.indexOf(from) === -1) {
      async.parallel([
        that.logMessage.bind(that, to, text, msg),
        that.executeCommands.bind(that, to, text, msg),
        that.executeHooks.bind(that, from, to, text, msg),
        that.executeAdminCommands.bind(that, from, to, text, msg)
      ]);
    }
  };
 ...
 */
TreslekBot.prototype.executeAdminCommands = function(from, to, text, msg, callback) {
  var args = text.split(' '),
 ...
 */
TreslekBot.prototype.executeCommands = function(from, to, text, msg, callback) {
  var command, plugin;
 ...
 * by loaded plugins.
 */
TreslekBot.prototype.executeHooks = function(from, to, text, msg, callback) {
  var that = this;
 ...
 */
TreslekBot.prototype.logMessage = function(from, to, text, msg, callback) {
  var that = this,
