...
var Sandbox = function(conf, irc, redisClient, commands, usage) {
  ...
  this.bot = {
    ...
    broadcast: function(msg) {
      Object.keys(irc.chans).forEach(function(chan) {
        irc.say(chan, msg);
      });
    },

    users: function(chan) {
      var chanData = irc.chanData(chan);

      if (chanData && chanData.hasOwnProperty('users')) {
        return Object.keys(chanData.users);
      }
